...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spyboat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11252&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spyboat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spyboat` can be installed with:

```
conda install spyboat
```

It is possible to list all of the versions of `spyboat` available on your platform with:
